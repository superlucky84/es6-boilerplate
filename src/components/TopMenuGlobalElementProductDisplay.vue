<template>
  <div :class="{off: !isProductCategoryEnabled}">
    ...
    <div class="path2_foot">
      <button
          :disabled="!isProductCategoryEnabled || !isPossibleAddFullColumnElement"
          type="button"
          class="foot_btn btn-blue ti-product-element-add"
          @click="addNewProductList">요소 추가</button>
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    isProductCategoryEnabled() {
      return this.productCategory.enabled;
    },
    productCountOptions() {
